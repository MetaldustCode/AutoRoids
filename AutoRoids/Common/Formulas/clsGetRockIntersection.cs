...
namespace AutoRoids
{
    internal class clsGetRockIntersection
    {
            ...
            for (int i = 0; i < lstRock.Count; i++)
            {
                for (int b = 0; b < lstBorder.Count; b++)
                {
...

                    {
                        ...
                        Boolean bolIntersect = clsGetIntersection.LineSegementsIntersect(
        ...
        {
            clsGetRockIntersection clsTrimCommon = new clsGetRockIntersection();
